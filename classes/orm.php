...
class ORM {
	...
	// Model configuration
	protected $_table_names_pluralize = TRUE;
	...
	(
		'object_name', 'object_pluralize', 'loaded', 'saved', // Object
	...
	{
		// Set the object name and pluralize name
		$this->_object_name   = strtolower(substr(get_class($this), 6));
		$this->_object_pluralize = Inflector::pluralize($this->_object_name);
	...
	protected function _initialize()
	{
		...
		if (empty($this->_table_name))
		{
			...
			if ($this->_table_names_pluralize === TRUE)
			{
				// Make the table name pluralize
				$this->_table_name = Inflector::pluralize($this->_table_name);
			}
		}
